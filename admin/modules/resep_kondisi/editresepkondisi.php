...
<body class="dashboard-body">
    ...
    <div class="main-wrapper">
        ...
        <main class="content-area">
            ...
            $page_title = "Edit Resep - Kondisi Kesehatan";
            ...
            $query = "SELECT * FROM resep_kondisi WHERE id_resep_kondisi = ?";
            ...
            $form_input = isset($_SESSION['form_input']) ? $_SESSION['form_input'] : $data;
            ...
            <div class="container mx-auto py-8">
                <div class="card">
                    <div class="card-header">
                        <h2>Edit Resep - Kondisi Kesehatan</h2>
                    </div>
                    <div class="card-body">
                        <?php
                        ...
                        ?>
                        <form action="<?php echo $base_url; ?>konfirmasieditresepkondisi.php" method="POST">
                            <input type="hidden" name="id_resep_kondisi" value="<?php echo htmlspecialchars($id); ?>">
                                ...
                                <select id="id_resep" name="id_resep" required>
                                    ...
                                    <?php foreach ($resep_list as $resep): ?>
                                        <option value="<?php echo $resep['id_resep']; ?>" 
                                            <?php echo ($form_input['id_resep'] == $resep['id_resep']) ? 'selected' : ''; ?>>
                                ...
                                <select id="id_kondisi" name="id_kondisi" required>
                                    ...
                                    <?php foreach ($kondisi_list as $kondisi): ?>
                                        <option value="<?php echo $kondisi['id_kondisi']; ?>"
                                            <?php echo ($form_input['id_kondisi'] == $kondisi['id_kondisi']) ? 'selected' : ''; ?>>
