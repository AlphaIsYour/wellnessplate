...
<body>
    ...
    <div class="content">
        <h2>Kelola Bahan</h2>
        <a href="add_bahan.php" class="btn btn-tambah">Tambah Bahan</a>
        <table>
            <tr>
                <th>ID Bahan</th>
                <th>Nama Bahan</th>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_bahan.php?id=<?php echo $row['id_bahan']; ?>" class="btn btn-edit">Edit</a>
                    <a href="?hapus=<?php echo $row['id_bahan']; ?>" class="btn btn-hapus" onclick="return confirm('Yakin hapus?')">Hapus</a>
                </td>
            </tr>
            <?php } ?>
        </table>
